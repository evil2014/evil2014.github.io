...
(lib.lazy_txt = function() {
	...
	// Layer 1
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_txt04", width:"85", expand:"up+down",size:10});
	this.text.setTransform(374,-7.8);
	...
	this.text_14.setTransform(16,26);
